...
\item Interpretabilidad de los resultados en términos de comportamiento de los nodos.
\item Caracterízación explícita de la incertidumbre sobre las inferencias realizadas, a manera de entregar información completa y transparente que apoye mejor el análisis criminal
\item Capacidad de realizar inferencia sobre sujetos con relativamente poco historial, utilizando información de la red para apoyar las inferencias.
